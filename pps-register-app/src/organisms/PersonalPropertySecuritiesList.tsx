  ...
  return (
    <article className={className}>
      ...
      <LoaderWrapper loading={isFetching}>
        <section className="grid grid-cols-8 min-h-10 border border-gray-200 rounded-2xl divide-x divide-y divide-gray-200 overflow-hidden">
          ...
          {personalPropertySecurities &&
            personalPropertySecurities?.map((pps) => (
              <Fragment key={pps.id}>
                ...
                <p className="p-2">
                  {pps.registrationStartDate.toLocaleDateString()}
                </p>
